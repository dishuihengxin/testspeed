...
echo "# Author: kalid <dishuihengxin@gmail.com>                     #"
echo "# Github: https://github.com/dishuihengxin                    #"
echo "#############################################################"
echo
echo "测试服务器到"
...
if  [ ! -e './speedtest.py' ]; then
    wget https://raw.githubusercontent.com/dishuihengxin/testspeed/master/speedtest.py > /dev/null 2>&1
fi
